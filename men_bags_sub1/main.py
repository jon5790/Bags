...
# Hardcoded subcategory URLs for Men's Bags & Leather Goods
SUBCATEGORY_URLS = [
    "https://www.boutiqaat.com/ar-kw/men/bags-leather-goods/crossbody-bags/l/",
    "https://www.boutiqaat.com/ar-kw/men/bags-leather-goods/laptop-work-bags/l/",
    "https://www.boutiqaat.com/ar-kw/men/bags-leather-goods/duffel-bags/l/",
    "https://www.boutiqaat.com/ar-kw/men/bags-leather-goods/backpacks/l/",
    "https://www.boutiqaat.com/ar-kw/men/bags-leather-goods/luggage/l/",
    "https://www.boutiqaat.com/ar-kw/men/bags-leather-goods/passport-holders/l/",
    "https://www.boutiqaat.com/ar-kw/men/bags-leather-goods/wallets/l/",
    "https://www.boutiqaat.com/ar-kw/men/bags-leather-goods/card-holders/l/",
    "https://www.boutiqaat.com/ar-kw/men/bags-leather-goods/wash-bags/l/",
    "https://www.boutiqaat.com/ar-kw/men/bags-leather-goods/waist-bags/l/",
]
...
class BoutiqaatDataPipeline:
    ...
    def run(self) -> bool:
        ...
        logger.info("=" * 80)
        logger.info("Starting Men's Bags & Leather Goods Pipeline (Async – Semaphore=3)")
        logger.info("=" * 80)
        try:
    ...
    def _upload_product_image(self, product: Dict, category_name: str, subcategory_name: str) -> str:
        ...
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/men/bags/images/"
                f"{safe_category}"
            )
    ...
    def _upload_excel_file(self, local_path: str, category_name: str) -> bool:
        ...
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/men/bags/excel-files"
            )
